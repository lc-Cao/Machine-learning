...
from data.make_data_digits import X, Y, X_train, Y_train, mini_batch_n, X_test, Y_test, X_train_full, X_train_scaled
...
save_models(my_model, "models/my_model_digits.pkl")
save_predictions(Y_test, my_y_pred, my_y_proba, "results/Predictions_digits.csv")
save_learning_curve(Loss[0], Loss[1], "results/Learning_curve_digits.csv")
...
print("\n" + "=" * 50)
print("自己模型 - Digits (0/1)")
evaluate(my_y_pred, Y_test)
print("\n" + "=" * 50)
print("sklearn 模型 - Digits (0/1)")
evaluate(sk_y_pred, Y_test)

# Loss曲线
from src.utils import plot_loss_curve
plot_loss_curve(Loss[0], Loss[1], "results/figures/Loss_curve_digits.png")

# 决策边界
from src.utils import plot_decision_boundary
plot_decision_boundary(my_model, X_test, Y_test, "results/figures/decision_boundary_digits.png")
